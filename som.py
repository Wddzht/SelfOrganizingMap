...
class SOM(object):
    ...
    def plot_distance_point_map(self, data, targets, targetnames, filename=None, colors=None, markers=None, example_dict=None,
                       density=True, activities=None, colormap='Oranges'):
        """ Visualize the som with all data as points around the neurons
